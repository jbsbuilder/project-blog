<section class="pt-40 p-10 md:p-20 dark:bg-slate-800" id="section-4"> 
  ...
  <div class="flex flex-col gap-y-3 md:flex-row md:space-x-3 justify-center">
    <div class="p-6 bg-white rounded-xl flex items-center space-x-5 dark:bg-slate-600">
      <div>
        <svg class="w-6 h-6 text-primary-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
    ...
    <div class="p-6 bg-white rounded-xl flex items-center space-x-5 dark:bg-slate-600">
      <div class="">
        <svg class="w-6 h-6 text-primary-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
